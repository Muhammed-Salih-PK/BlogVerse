...
export default function ArticlesClient({ articles, categories, tags }) {
  ...
  const filteredArticles = useMemo(() => {
    ...
    if (sortOption === "newest") filtered.sort((a, b) => new Date(b.publishedAt) - new Date(a.publishedAt));
    if (sortOption === "oldest") filtered.sort((a, b) => new Date(a.publishedAt) - new Date(b.publishedAt));
    if (sortOption === "popular") filtered.sort((a, b) => (b.meta?.likes || 0) - (a.meta?.likes || 0));
    return filtered;
