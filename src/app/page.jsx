    ...
    <>
      ...
      <section className='relative min-h-[80vh] flex items-center justify-center bg-gradient-to-br from-gray-900 via-purple-900 to-violet-800 overflow-hidden px-4 py-20 md:py-32'>
        ...
        <div className='absolute inset-0'>
          ...
          <div className='absolute -bottom-20 -right-20 w-96 h-96 bg-violet-600 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float-delay'></div>
        </div>
          ...
          <div className='container mx-auto max-w-6xl'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
              {featuredPosts.map((post) => (
                <div
                  key={post._id}
                  className='bg-white dark:bg-gray-700 rounded-xl shadow-md overflow-hidden transition-transform hover:scale-[1.02]'
                >
                  <div className='h-48 relative'>
                    ...
                    <div className='absolute top-4 left-4 bg-purple-600 text-white px-3 py-1 rounded-full text-sm font-medium'>Featured</div>
                  </div>
                  <div className='p-6'>
                ...
                <div className='space-y-8'>
                  {paginatedArticles.map((post) => (
                    <article key={post._id} className='border-b border-gray-200 dark:border-gray-700 pb-8'>
                      <div className='flex flex-col sm:flex-row gap-6'>
                        <div className='sm:w-1/3 bg-gray-200 dark:bg-gray-600 h-48 rounded-lg overflow-hidden'>
                          {post.featuredImage && (
                            <img src={post.featuredImage} alt={post.title} className='w-full h-full object-cover' loading='lazy' />
                          )}
                        </div>
              ...
              {loading ? (
                ...
                <>
                  <div className='bg-white dark:bg-gray-700 p-6 rounded-xl shadow'>
                    ...
                    <button className='w-full bg-purple-600 hover:bg-purple-700 text-white py-2 rounded-lg transition-colors'>Learn More</button>
                  </div>
