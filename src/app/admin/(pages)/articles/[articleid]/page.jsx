...
export default function ArticlePage() {
  ...
  if (error) {
    return <Error error={error} backtext={"Back to Articles"} />;
  }
    ...
    <>
      ...
      <article className='max-w-4xl  mx-auto px-4 py-12 '>
        ...
        <div className='my-5 flex justify-between'>
          <button onClick={() => router.back()} className='text-purple-600 dark:text-purple-400 hover:underline flex items-center'>
            ← Back
          </button>
        </div>
        {/* Article Header */}
